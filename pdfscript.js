...
var files = {
  ...
  logo: {
    url: 'http://127.0.0.1:5500/pdfkit-setup//logo.png',
  }
};
var filesLoaded = 0;
...
progressArc(590,100,40,10,0.80,"Overall")
progressBar(650,40,130,10,4,0.5,"Website")
progressBar(650,80,130,10,4,0.8,"Content")
progressBar(650,120,130,10,4,0,"Social Media")
